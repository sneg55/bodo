/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: e158b6f222ac0981495a345580852e4e)
// Runtime types generated with workerd@1.20260801.1 2026-08-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	BODO_KV: KVNamespace;
	BODO_UPLOADS: R2Bucket;
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	ASSETS: Fetcher;
	EMAIL_PROVIDER: "resend";
	ACCELEVENTS_MOCK: "1";
	NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace<import("./src/entrypoints/worker").DOShardedTagCache>;
	NEXT_CACHE_DO_QUEUE: DurableObjectNamespace<import("./src/entrypoints/worker").DOQueueHandler>;
	BODO_CLAIM_GUARD: DurableObjectNamespace<import("./src/entrypoints/worker").ClaimGuard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entrypoints/worker");
		durableNamespaces: "DOShardedTagCache" | "DOQueueHandler" | "ClaimGuard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_PROVIDER" | "ACCELEVENTS_MOCK">> {}
}
